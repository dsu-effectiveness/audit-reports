...
*Last Updated: `r unique(as_datetime(student_sql$daterun))`*
...
if(nrow(crse_check_03) > 0) {
  mkd_table(crse_check_03, "Student Level", unique(crse_check_03$error_message)) %>%
    cols_label(term = md("**Term**"),
               crn = md("**CRN**"),
               subject_code = md("**Subject**"),
               section_number = md("**Section**"),
...
if(nrow(crse_check_04) > 0) {
  mkd_table(crse_check_04, "Student Level", unique(crse_check_04$error_message)) %>%
    cols_label(term = md("**Term**"),
               crn = md("**CRN**"),
               subject_code = md("**Subject**"),
               section_number = md("**Section**"),
