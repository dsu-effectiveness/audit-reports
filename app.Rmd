...
if(nrow(ce_check_01) > 0) {
  mkd_table(ce_check_01, "SSID", unique(ce_check_01$error_message)) %>%
    cols_label(banner_id = md("**Student ID**"),
               first_name = md("**First Name**"),
               middle_name = md("**Middle Name**"),
               last_name = md("**Last Name**"),
               birth_date = md("**DOB**"),
               high_school_desc = md("**HS**"),
               ssid = md("**SSID**"),
               banner_table = md("**Table Name**"),
               banner_column = md("**Column Name**")
               ) %>%
...
```{r, message = FALSE, warning=FALSE, error = FALSE, echo = FALSE, fig.align='left'}
if(nrow(ce_check_03) > 0) {
  mkd_table(ce_check_03, "SSID", unique(ce_check_03$error_message)) %>%
    cols_label(term = md("**Term**"),
               banner_id = md("**Student ID**"),
               first_name = md("**First Name**"),
               middle_name = md("**Middle Name**"),
...
```{r echo=FALSE, error=FALSE, fig.align='left', message=FALSE, warning=FALSE}
if(nrow(ce_check_04) > 0) {
  mkd_table(ce_check_04, "HS Code", unique(ce_check_04$error_message)) %>%
    cols_label(term = md("**Term**"),
               banner_id = md("**Student ID**"),
               first_name = md("**First Name**"),
               last_name = md("**Last Name**"),
    ...
    cols_hide(c("season", "middle_name", "error_message"))
}
```
...
```{r, message = FALSE, warning=FALSE, error = FALSE, echo = FALSE}
ce_list <- list(ce_check_01, ce_check_02, ce_check_03, ce_check_04) 
